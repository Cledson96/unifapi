...
<html lang="en">
    <head>
        ...
        <title>Painel Administrativo - FAPI</title>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="text-center mt-0">
                        <a href="index.html" class="logo logo-admin"><img src="assets/images/logo.png" alt="logo"></a>
                    </h3>
                    <div class="p-3">    
                        <form name="form" method="post" class="w-100" action="inc/checkaccess.php" >                   
